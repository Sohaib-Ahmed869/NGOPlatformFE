  ...
  return (
    ...
    >
      ...
      <div className="flex-1 space-y-4 overflow-y-auto bg-gray-50/40 p-4 dark:bg-transparent">
        {/* meta */}
        <div className="grid grid-cols-2 gap-x-4 gap-y-3 rounded-lg border border-gray-100 bg-white p-4 dark:border-white/10 dark:bg-[var(--admin-card)]">
        ...
        {/* logo */}
        {item.logoUrl && (
          <a href={item.logoUrl} target="_blank" rel="noreferrer" className="flex items-center justify-center rounded-lg border border-gray-100 bg-white p-4 dark:border-white/10 dark:bg-[var(--admin-card)]">
        ...
        {/* message */}
        {item.message && (
          <div className="rounded-lg border border-gray-100 bg-white p-4 dark:border-white/10 dark:bg-[var(--admin-card)]">
