...
const Footer = () => {
  return (
    <footer className="relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-[#4A3F30] to-[#3D3226]" />
      {/* Subtle golden sheen */}
      <div className="absolute inset-0 bg-gradient-to-r from-[#C9A84C]/[0.02] via-transparent to-[#C9A84C]/[0.02] pointer-events-none" />

      <div className="relative max-w-7xl mx-auto px-6 pt-20 pb-10">
        {/* Top CTA bar */}
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 pb-14 mb-14 border-b border-[#C9A84C]/10">
          <div>
          ...
          <Link
            to="/donate"
            className="group relative inline-flex items-center gap-2 bg-gradient-to-r from-[#C9A84C] to-[#D4B85A] text-[#2C2418] font-semibold rounded-full px-8 py-3.5 overflow-hidden transition-all hover:shadow-[0_0_30px_rgba(201,168,76,0.25)]"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            <p className="text-[#EDE4D3]/50 text-sm leading-relaxed mb-6">
              Empowering communities worldwide through education, healthcare,
              food security, and emergency relief. Every donation makes a
              difference.
            </p>
            <div className="flex items-center gap-3">
              {[
                ...
                <a key={s.label} href={s.href} target="_blank" rel="noopener noreferrer" aria-label={s.label} className="w-9 h-9 rounded-full border border-[#C9A84C]/15 flex items-center justify-center text-[#EDE4D3]/40 hover:text-[#C9A84C] hover:border-[#C9A84C]/40 transition-all">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-xs font-body font-semibold text-[#C9A84C] tracking-[0.2em] uppercase mb-5">Quick Links</h4>
            <ul className="space-y-3">
              {[
                ...
                <li key={link.to}><Link to={link.to} className="text-[#EDE4D3]/40 hover:text-[#C9A84C] transition-colors text-sm font-body">{link.label}</Link></li>
              ))}
            </ul>
          </div>
          ...
          {/* Our Work */}
          <div>
            <h4 className="text-xs font-body font-semibold text-[#C9A84C] tracking-[0.2em] uppercase mb-5">Our Work</h4>
            <ul className="space-y-3">
              {[
          ...
          {/* Contact */}
          <div>
            <h4 className="text-xs font-body font-semibold text-[#C9A84C] tracking-[0.2em] uppercase mb-5">Contact</h4>
            <ul className="space-y-4">
              <li>
                <a href="mailto:info@hopegive.org" className="flex items-start gap-3 text-[#EDE4D3]/40 hover:text-[#C9A84C] transition-colors text-sm font-body">
                  <Mail className="w-4 h-4 mt-0.5 flex-shrink-0" />
                  info@hopegive.org
                </a>
              </li>
              <li>
                <a href="tel:+18004673448" className="flex items-start gap-3 text-[#EDE4D3]/40 hover:text-[#C9A84C] transition-colors text-sm font-body">
        ...
        {/* Bottom bar */}
        <div className="border-t border-[#C9A84C]/8 mt-14 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
